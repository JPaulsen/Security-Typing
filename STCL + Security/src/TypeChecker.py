...
class TypeChecker:
    ...
    def visitFunctionExpression(self, functionExpression):
        #TODO: (ask Raimil) What I really return (called x) has constraint x <= returnType
    ...
    def visitApplyExpression(self, applyExpression):
        # TODO: (ask Raimil) What I really receive (called x) has constraint x <= parameterType
